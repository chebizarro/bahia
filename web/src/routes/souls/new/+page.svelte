...
<div class="page">
  ...
  {#if step < 3}
    <div class="auth-status" class:authenticated={isAuthenticated} class:error={authError}>
      {#if authError}
        <WarningIcon size={22} strokeWidth={1.75} ariaHidden="true" />
      ...
      {:else if authState.status === 'authenticating'}
        <PendingIcon size={22} strokeWidth={1.75} ariaHidden="true" />
        <div><strong>Requesting permission</strong><p>Approve the signer prompt.</p></div>
      {:else}
        <LoginIcon size={22} strokeWidth={1.75} ariaHidden="true" />
  ...
  {#if error}
    <div class="error-banner"><WarningIcon size={18} strokeWidth={1.75} ariaHidden="true" /> {error}</div>
  {/if}

  {#if draftSaveStatus && step < 3}
    <div class="draft-status">
      <SuccessIcon size={18} strokeWidth={1.75} ariaHidden="true" />
