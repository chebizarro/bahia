...
- `AC-SFP-001` — **verified**. `TestMLSignerFirstProtocolNamespacesAndCanonicalPublishing` proves the legacy command/result constants occupy exactly `38390`-`38399`, avoid NIP-90 `5000`-`7000`, and production ML publishing emits signed ContextVM `25910` instead of legacy runtime events.
