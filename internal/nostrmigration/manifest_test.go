...
func TestManifestCoversBahiaInventoryLegacyKinds(t *testing.T) {
	...
	want = append(want, []int{5961, 5962, 5963, 5964, 5965, 5966, 5967, 5968, 5971, 5972, 5973, 5974, 5975, 5976, 5977, 5978, 5979, 5981, 5982, 5983, 5984, 5985, 5986, 5987, 5988, 5989, 5991, 5992, 5993, 5994, 5995, 5996, 5997, 5998, 5999, 6000, 6001, 6002, 6003, 6004, 6005}...)
	want = append(want, []int{6961, 6962, 6963, 6973, 6976, 6978, 6991, 6997}...)
	want = append(want, []int{7961, 7962, 7963, 7964, 7965, 7966, 7971, 7972, 7973, 7976, 7977, 7978, 7979, 7991, 7992, 7997}...)
...
func parseKindsGoConstants(t *testing.T) map[string]int {
	...
	cascadiaConstants := map[string]int{
		...
		"CAS_AGENT_CAPABILITY":                  cascadia.CAS_AGENT_CAPABILITY,
		...
		"NIP78_APP_DATA":                        cascadia.NIP78_APP_DATA,
