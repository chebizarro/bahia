...
func assistantAsyncToolDefinitions() []Tool {
	...
	return []Tool{
		{Name: "bahia_assistant_service_deploy", Description: "Assistant-safe async service deploy command (kind 5961)", InputSchema: obj(map[string]interface{}{"service_id": id, "environment_id": id, "artifact_id": id, "idempotency_key": id}, "service_id", "environment_id", "artifact_id", "idempotency_key")},
		{Name: "bahia_assistant_service_rollback", Description: "Assistant-safe async service rollback command (kind 5962)", InputSchema: obj(map[string]interface{}{"service_id": id, "environment_id": id, "idempotency_key": id}, "service_id", "environment_id", "idempotency_key")},
		{Name: "bahia_assistant_llm_deploy", Description: "Assistant-safe async LLM deploy command (kind 5973)", InputSchema: obj(map[string]interface{}{"route_id": id, "environment_id": id, "release_id": id, "requested_by": id, "idempotency_key": id}, "route_id", "environment_id", "release_id", "idempotency_key")},
		{Name: "bahia_assistant_llm_approve_deployment", Description: "Assistant-safe async LLM approval command (kind 5974)", InputSchema: obj(map[string]interface{}{"intent_id": id, "decision": id, "idempotency_key": id}, "intent_id", "decision", "idempotency_key")},
		{Name: "bahia_assistant_llm_rollback", Description: "Assistant-safe async LLM rollback command (kind 5975)", InputSchema: obj(map[string]interface{}{"route_id": id, "environment_id": id, "requested_by": id, "idempotency_key": id}, "route_id", "environment_id", "idempotency_key")},
		{Name: "bahia_assistant_ml_deploy", Description: "Assistant-safe async ML deploy command (kind 38391)", InputSchema: obj(map[string]interface{}{"endpoint": id, "endpoint_id": id, "model_version": id, "model_version_id": id, "runtime_preference": id, "runtime": id, "placement": map[string]interface{}{"type": "object"}, "tags": map[string]interface{}{"type": "object"}, "idempotency_key": id}, "idempotency_key")},
		{Name: "bahia_assistant_ml_approve_deployment", Description: "Assistant-safe async ML approval command (kind 38392)", InputSchema: obj(map[string]interface{}{"intent_id": id, "decision": id, "tags": map[string]interface{}{"type": "object"}, "idempotency_key": id}, "intent_id", "decision", "idempotency_key")},
		{Name: "bahia_assistant_ml_rollback", Description: "Assistant-safe async ML rollback command (kind 38393)", InputSchema: obj(map[string]interface{}{"endpoint": id, "endpoint_id": id, "requested_by": id, "tags": map[string]interface{}{"type": "object"}, "idempotency_key": id}, "idempotency_key")},
	}
}
