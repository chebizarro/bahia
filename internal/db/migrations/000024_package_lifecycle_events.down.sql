...
ALTER TABLE package_publications_projection
    ...
    CHECK (status IN ('pending', 'published', 'promoting', 'promoted', 'rejected', 'rolled_back', 'failed'));
...
ALTER TABLE package_intents_projection
    ...
    CHECK (operation IN ('repository_apply', 'repository_delete', 'artifact_publish', 'artifact_delete', 'promote'));
