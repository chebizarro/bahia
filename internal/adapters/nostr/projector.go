...
func dnsEndpointFingerprint(endpoint domain.DNSEndpoint) (string, error) {
	// MaterializedAt records when the read model was refreshed, not a change to
	// the endpoint itself. Including it would create a fresh replaceable event
	// on every reconciliation pass and can saturate relay publication limits.
